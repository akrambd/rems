	...
	elseif(isset($_POST['date_fix']))
		 {
			   ...
			   if($end)
					...
					try {
						...
						$mail->Body    = ''.$user_name.', your requested '.$property_id.' no Properties  Inspection Schedule : '.$inspection_date.' at '.$inspection_time.'  ' ;
	 ...
	 elseif(isset($_POST['delete']))
      ...
      //          $_SESSION['inspection_date']= $data['inspection_date'];					
      //          $_SESSION['inspection_time']= $data['inspection_time'];
