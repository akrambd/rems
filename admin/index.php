...
if($_SESSION['email']!=null)
{
		 ...
		 $sql= $conn->prepare("SELECT * FROM admin_info WHERE admin_id='$id'");
		 $sql->execute();
         ...
         $sqlAdmin= $conn->prepare("SELECT * FROM admin_info WHERE admin_id='$id'");
         $sqlAdmin->execute();
         $valueAdmin = $sqlAdmin->fetch(PDO::FETCH_ASSOC);
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    <img src=" <?php echo $_SESSION['img_url'];?> " height="150" width="150" class="user-image img-responsive"/>
					</li>
					...
					<!-- <li>
                        <a href="#"><i class="fa fa-user fa-2x" style="color: #00c0ef;"></i>Manage Sub-admin<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="index.php?page=create_sub_admin">Create Sub-Admin</a>
                            </li>
                            <li>
                                <a href="index.php?page=manage_sub_admin">Manage Sub-Admin</a>
                            </li>                           
                        </ul>
                     </li>   -->
					  
                    <li>
                        <a href="#"><i class="fa fa-user fa-2x" style="color: #00a65a;"></i>Manage User<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-user fa-2x" style="color: lightblue;"></i>Manage Agent<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="index.php?page=request_agent">Request</a>
                            </li>
                            <li>
                                <a href="index.php?page=active_agent">Active</a>
                            </li>
                            <li>
                                <a href="index.php?page=block_agent">Block</a>
                            </li>
                        </ul>
                    </li>  
					<li>
		       ...
		       <?php 
				  switch (@$_GET['page']) {
                            ...
                            case "admin_profile_update": {
                                include("admin_profile_update.php");
                            }
                            break;
                            ...
                            case "manage_sub_admin": {
                                include("manage_sub_admin.php");
                            }
                            break;
                            ...
                            case "request_agent": {
                                include("request_agent.php");
                            }
                            break;

                            case "active_agent": {
                                include("active_agent.php");
                            }
                            break;
                            
                            case "block_agent": {
                                include("block_agent.php");
                            }
                            break;
