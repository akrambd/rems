<?php
    $sql = $conn->prepare("SELECT * FROM property_info,property_type_list WHERE property_info.property_type=property_type_list.property_type_id AND active_status_property='1'");
    $sql->execute();
    $value = $sql->fetchAll();
...
<div class="col-lg-3 col-sm-4 ">
  ...
  <div class="search-form">
    ...
    <form action="index.php?page=sell_property" method="POST" class="form form-group">
