<?php
		 ...
		 $sqlUser = $conn->prepare("SELECT * FROM user_info where `active_status_user`='1' ORDER BY `user_id` DESC");
		 $sqlUser->execute();
		 ...
		 {
			   $id = $_POST['user_id'];			
			   $query = "UPDATE `user_info` SET `active_status_user`='2' where user_id='$id'";
		...
		$sms = '<div class="alert alert-success alert-dismissable"><a ref="#" class="close" data-dismiss="alert" aria-label="close">&times;</a><strong> <h2 style="text-align: center; font-weight: bolder;">Account blocked!</h2></strong> </div>';
		}else{
		
		$sms = '<div class="alert alert-success alert-dismissable"><a ref="#" class="close" data-dismiss="alert" aria-label="close">&times;</a><strong> <h2 style="text-align: center; font-weight: bolder;">Account not blocked!</h2></strong> </div>';
		}
	}
...
<div id="page-inner">
	 ...
	 <?php if(isset($sms)){echo $sms;} ?>
             ...
             <div class="panel-heading" style="text-align:center; font-weight: bolder; font-size: 18px; color: green;">Active user list  </div>
